...
7. `/notebooks/Preprocessing/7.add_SA2_2016.ipynb`: this notebook further added 2016 SA2 code as we realised that the SA2 code may change every 5 year. Hence to reduce data loss, we will append both 2016 and 2021 SA2 code for each property instance.

8. `/notebooks/Preprocessing/8.organising.ipynb`: this notebook will organise the column names after adding 2016 SA2 code to distinguish from the 2021 SA2 code.

### 2.1.5 Feature Engineering for Property Dataset

`/models/classify_property_type.ipynb`: this notebook will classify "Other" type of residence type into either "House" or "Apartment" with logistic regression model.
